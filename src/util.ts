export class Util extends null {
    public static subtractSets<T>(lhs: Set<T>, rhs: Set<T>): Set<T> {
    ...
    public static replaceKeys<T extends object, KVs extends { [K in keyof T]?: string }>(
        object: T, keys: KVs
    ): Util.ReplaceKeys<T, KVs> {
        ...
        return finalObject as Util.ReplaceKeys<T, KVs>;
    }

    public static hasOneOfKeys<T extends object>(object: T, keys: Array<keyof T>): boolean {
